...
const Sidebar = () => {
  ...
  return (
    <section
      className={`${
        menu ? "right-0" : "hidden"
      } absolute h-fit rounded-bl-2xl duration-500 z-10 bg-yellow-50 sm:z-0 sm:flex sm:relative sm:left-0 sm:rounded-bl-none sm:translate-x-0 sm: px-5 py-3  w-48 md:w-56 sm:h-[calc(100vh-5rem)] flex-col gap-y-5 sm:pb-24 overflow-y-scroll border-x-2 border-b-2 sm:border-b-0 scrollbar`}
    >
      <div
        onClick={() => {
